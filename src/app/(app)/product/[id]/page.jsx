        ...
        <div className="max-w-[80%] mx-auto">
            <div className="flex gap-8 items-center p-6 mt-20 min-h-[70vh]">
                ...
                <div className="w-1/2 h-full py-4 px-8 bg-gray-100">
                    ...
                    <div className="text-xl mb-4">Price : <span className="text-xl gap-8 text-yellow-900">Rs {product.productPrice}</span></div>
                    <p className="text-md mt-1 capitalize">{product.productCategory } : {product.productFor} </p>
                    <div className="flex justify-between  mt-4 py-4 border-t border-gray-400">
                        {isInCartList ? (
                            <Link href={"/cart"}>
                                <button className="border border-green-800 mr-11 rounded-2xl px-2 py-2 ">
                                    Go to Cart
                                </button>
                            </Link>
                        ) : (
                            <button
                                ...
                                className="border border-green-800 mr-11 rounded-2xl px-2 py-2 "
                            >
                                Add to Cart
                            </button>
                        )}
